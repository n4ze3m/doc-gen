    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center mt-2" href="/">
          <AppLogo gradientSize="size-8 mt-2" iconSize="size-5" />
          <span className="ml-2 text-2xl font-bold text-gray-900">DocGen</span>
        </Link>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <AppLogo gradientSize="w-24 h-24" iconSize="w-16 h-16" />
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                AI-Powered PDF Generation Made Easy
              </h1>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                DocGen simplifies PDF creation with AI-driven generation and
              ...
              <div className="space-x-4">
                ...
                <Button
                  onClick={() =>
                    window.open("https://github.com/n4ze3m/doc-gen", "_blank")
                  }
                  variant="outline"
                >
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                <BrainCircuitIcon className="h-12 w-12 mb-4 text-blue-500" />
              ...
              <div className="flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-md">
                <LayoutTemplateIcon className="h-12 w-12 mb-4 text-blue-500" />
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <div className="p-2 bg-blue-100 rounded-full">
                    <LayoutTemplateIcon className="h-6 w-6 text-blue-500" />
                  </div>
              ...
              <div className="rounded-lg border bg-card text-card-foreground shadow-sm">
                <div className="p-6 flex flex-col items-center text-center space-y-4">
                  <div className="p-2 bg-blue-100 rounded-full">
                    <MousePointerClickIcon className="h-6 w-6 text-blue-500" />
                  </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 DocGen. All rights reserved.
        </p>
      </footer>
    </div>
  );
